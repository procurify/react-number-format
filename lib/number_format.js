...
var propTypes = {
  ...
  minimumDecimalScale: _propTypes["default"].number,
  forceValidateOnBlur: _propTypes["default"].bool,
  ...
  allowTrailingZeros: _propTypes["default"].bool,
  ...
  getInputRef: _propTypes["default"].oneOfType([_propTypes["default"].func,
  // for legacy refs
...
var NumberFormat = /*#__PURE__*/function (_React$Component) {
  function NumberFormat(props) {
    ...
    _this = _callSuper(this, NumberFormat, [props]);
  ...
  return _createClass(NumberFormat, [{
    ...
    value: function isCharacterAFormat(caretPos, value) {
      var _this$props0 = this.props,
        format = _this$props0.format,
        prefix = _this$props0.prefix,
        suffix = _this$props0.suffix,
        decimalScale = _this$props0.decimalScale,
        fixedDecimalScale = _this$props0.fixedDecimalScale;
    ...
    value: function onBlur(e) {
      ...
      if (!format || forceValidateOnBlur) {
        ...
        if (!allowTrailingZeros) {
          numAsString = (0, _utils.fixTrailingZeros)(numAsString);
        }
        if (minimumDecimalScale > 0) {
          numAsString = (0, _utils.fixMinimumDecimalScale)(numAsString, minimumDecimalScale);
        }
