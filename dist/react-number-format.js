...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.NumberFormat = factory(global.React));
  ...
  var NumberFormat = /*#__PURE__*/function (_React$Component) {
    ...
    return _createClass(NumberFormat, [{
      ...
      value: function render() {
        ...
        if (displayType === 'text') {
          return renderText ? renderText(value) || null : /*#__PURE__*/React__default["default"].createElement("span", _extends({}, otherProps, {
            ref: getInputRef
          }), value);
        } else if (customInput) {
          var CustomInput = customInput;
          return /*#__PURE__*/React__default["default"].createElement(CustomInput, _extends({}, inputProps, {
            ref: getInputRef
          }));
        }
